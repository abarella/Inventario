...
$_SG['usuario'] = 'alberto';       // Usuário MySQL
$_SG['senha'] = '010359ABJ';       // Senha MySQL
$_SG['banco'] = 'luana';           // Banco de dados MySQL
*/

$_SG['servidor'] = 'localhost';         // Servidor MySQL
$_SG['usuario'] = 'abjinfo_invusr';     // Usuário MySQL
$_SG['senha'] = 'ABj*010359';           // Senha MySQL
$_SG['banco'] = 'abjinfo_inventario';   // Banco de dados MySQL


$_SG['paginaLogin'] = 'http://inventario.abjinfo.com.br/login.php'; // Página de login
